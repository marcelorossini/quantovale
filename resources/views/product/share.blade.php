...
<main class="grey lighten-4 valign-wrapper">
  <div class="container">
    ...
    @if ( !is_null( $aMessenger['profile'] ) )
    <div class="row">
      <div class="col s12 m12 l4 offset-l8 right-align">
        <a href="{{ $aMessenger['profile'] }}" id="sendMessenger" class="waves-effect waves-light btn blue" style="width: 100%;"><i class="mdi mdi-facebook-messenger"></i> ENVIE UMA MENSAGEM PARA {{ strtoupper(strtok($tabUsuario->name,' ')) }}</a>
      </div>
    </div>
    @endif
    <!--
